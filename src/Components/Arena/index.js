...
const Arena = ({ characterNFT, setCharacterNFT }) => {
    ...
    // We are going to use this to add a bit fancy animations during attacks
    ...
    useEffect(() => {
        ...
        // Logic for when this event is fired off
        ...
        // We clean up this event when this component is removed
        return () => {
            if (gameContract) {
